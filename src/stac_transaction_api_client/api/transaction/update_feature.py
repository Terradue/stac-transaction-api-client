...
def sync_detailed(
    ...
    *,
    ...
    """update an existing feature by Id with a complete item definition
     ...
     Use this method to update an existing feature. Requires the entire GeoJSON  description be
    submitted.
    ...
    Args:
        ...
        feature_id (str):
        if_match (str):
        body (PostOrPutItem | Unset): An object that is a valid GeoJSON Feature, but not
            necessarily a valid STAC Item.
